...
export const ModalEliminarCandidatoGenerico = ({ statusDeleteModal, handleToggleModal }) => {
		...
		>
			<Box sx={style}>
				...
				<Typography id="modal-modal-title" variant= "h4"  color="initial" align="center" mr={5} ml={5} mb={2}>
                    Si eliminas el candidato desaparecerá para siempre. ¿Está seguro que deseas continuar?
				</Typography>
				<Box ml={"2rem"} mr={"2rem"}

...
export const ModalEliminarCandidato = ({ statusDeleteCandidatoModal, handleToggleModal, id }) => {
	...
	return (
		<Modal
			open={statusDeleteCandidatoModal}
		...
		>
			<Box sx={style}>
				...
				<Typography id="modal-modal-title" variant= "h4"  color="initial" align="center" mr={5} ml={5} mb={2}>
                    Si eliminas el Candidato desaparecerá para siempre. ¿Estás seguro que deseas continuar?
				</Typography>
				<Box ml={"2rem"} mr={"2rem"}

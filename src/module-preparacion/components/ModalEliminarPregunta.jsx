...
export const ModalEliminarPregunta = ({ statusDeleteModal, handleToggleModal }) => {
		...
		>
			<Box sx={style}>
				...
				<Typography id="modal-modal-title" variant= "h4"  color="initial" align="center" mr={5} ml={5} mb={2}>
                    Si eliminas la pregunta desaparecerá para siempre. ¿Está seguro que deseas continuar?
				</Typography>
				<Box ml={"2rem"} mr={"2rem"}

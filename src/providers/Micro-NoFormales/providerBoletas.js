...
export const getBoletaProvider = async (idBoleta) => {
  ...
  return jornadaNoFormalAPI
    .get(`jornada/no_formal/estructura_boleta/${idBoleta}/modalidad/candidatos`)
    .then((response) => {
...
export const putCandVotoNFProvider = async (idBoleta, datasend) => {
  ...
  return jornadaNoFormalAPI
    .put(
      `jornada/no_formal/boleta/${idBoleta}/modalidad/config_candnoreg_votonull`,
      datasend
    )
    .then((response) => {
...
export const putMaxMinNFProvider = async (idBoleta, datasend) => {
  ...
  return jornadaNoFormalAPI
    .put(
      `jornada/no_formal/boleta/${idBoleta}/modalidadvotacion/config_min_max`,
      datasend
    )
    .then((response) => {

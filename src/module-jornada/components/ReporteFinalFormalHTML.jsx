...
export const ReporteFinalFormalHTML = ({
  ...
  console.log("jornadaVotosData", jornadaVotosData);
            ...
            <Box>
              ...
              >
                {jornadaSelected.boletas.map((boleta) => {
                  if (jornadaVotosData.boleta.idBoleta === boleta.idEstructuraBoleta)
                    ...
                    {/* <Grid item xs={5}>
                      ...
                      >
                        {resultado?.fotos?.map((foto) => (
                          <img ref={canvas} height="25px" width="25px" src={foto}></img>
                        ))}
                      </Box>
                    </Grid> */}
                    <Grid item xs={12}>
